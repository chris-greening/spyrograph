...
In this section, we'll provide an **overview** of spirograph animations and discuss how the `animate` method in the [Spyrograph](https://github.com/chris-greening/spyrograph) library can help us create **stunning visual displays** with ease
...
A spirograph is a **geometric shape** formed by **tracing** a point a distance from the center of a **circle** as it rolls along the **inside or outside** of a **fixed circle**
...
<p align="center">
  <img src="{{ site.url }}{{ site.baseurl }}/images/animation_modify_color_width.gif" alt="An animation of lines rotating creating beautiful geometric patterns colored in red with a thicker width">
</p>
